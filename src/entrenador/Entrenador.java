...
public class Entrenador implements IEntrenable {
    ...
    public Entrenador(String nombre, ArrayList<Pokemon> equipo, ArrayList<Pokemon> caja) {
        ...
        this.equipo = equipo;
        this.caja = caja;
        //equipo.add(generarPokemonAleatorio(1));

    }

    public Entrenador(int nivelMedioEquipo) {
        Random rnd = new Random();
        String[] nombres = { "Fernando", "Xin Lu", "Yasuo", "Super", "Pepe", "Luis Manuel", "Paco", "Juaniko",
                "Ash Ketchup", "Fran", "Pedro", "Jose Carlos", "Angel", "Luis", "Markos" };
    ...
    public void ponerACriar(Pokemon pokemon1, Pokemon pokemon2) {
        ...
        if (pokemon1.getFertilidad() > 0 && pokemon2.getFertilidad() > 0) {
            pokemon1.setFertilidad(pokemon1.getFertilidad() - 1);
            pokemon2.setFertilidad(pokemon2.getFertilidad() - 1);
